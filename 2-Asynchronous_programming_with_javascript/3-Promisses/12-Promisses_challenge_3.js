...
// Challenge 1
// Implement the method to get a list of results of all the promises and console log how many failed and how many accepted
...
Promise.all([p1, p2, p3, p4])
  ...
  .catch((error) => console.log("Challenge 2:", error));
